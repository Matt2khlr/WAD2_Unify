        ...
        <div v-if="mode === 'signin'" class="auth-form">
          ...
          <form @submit.prevent="onSignIn()">
            <div class="form-group">
              ...
              <input id="si-email" v-model="siEmail" type="email" class="form-input" placeholder="your@email.com"
          ...
          <form @submit.prevent="onSignUp()">
            <div class="form-group">
              ...
              <input id="su-username" v-model="suUsername" type="text" class="form-input"
                placeholder="Enter your username" autocomplete="username" minlength="3" required />
            </div>
            <div class="form-group">
              <label for="su-email" class="form-label">Email</label>
              <input id="su-email" v-model="suEmail" type="email" class="form-input" placeholder="your@email.com"
                autocomplete="email" required />
            </div>
