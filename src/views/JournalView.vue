  ...
  <div class="min-vh-100 bg-gradient p-5">
    <div class="container">
      ...
      <div class="card mood-card text-white shadow mb-5 p-4">
        ...
        <p class="text-center text-white-75">Track your mood daily to identify patterns and improve wellbeing
        </p>
      </div>
      ...
      <div class="card journal-card mb-4">
        ...
        <div class="card-body">
          ...
          <div v-else-if="journalHistory.length">
            <div v-for="entry in journalHistory" :key="entry.id" class="card card-body mb-2 p-3"
              ...
              <div v-else>
                ...
                <span v-if="entry.mood" class="badge rounded-pill mt-2 align-self-start"
