...
<template>
    <section class="container py-3">
            ...
            <div class="col-12 col-md-6">
                <div class="card h-100 shadow-sm">
                    <div class="card-body d-flex align-items-center justify-content-around">
                        ...
                        <div class="text-center"><Utensils class="text-dark mb-2" :size="24" /><div class="fw-bold">{{ netCaloriesDisplay }}</div><div class="small text-muted">Net kcal</div></div>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6">
                        ...
                        <label class="form-label d-flex align-items-center justify-content-between">
                            ...
                            <div class="ios-switch-container">
                                <input 
                                    ...
                                    v-model="useAutoCalorie"
                                >
                                <label class="ios-switch-label" for="autoKcal">
                                    <span class="ios-switch-slider"></span>
                                </label>
                                <label class="form-check-label ms-2" for="autoKcal">
                                    Auto
                                </label>
                            </div>
                        </label>
                        <input v-if="useAutoCalorie" type="number" class="form-control" :value="suggestedCalorie" disabled />
                        <input v-else ref="kcalInputRef" type="number" min="0" class="form-control" v-model="calorieInput" placeholder="e.g., 2000" @keydown.stop @keyup.stop @keypress.stop />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card shadow-sm mb-3 border-0 rounded-3">
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <button v-for="a in QUICK_ACTIVITIES" :key="a.name" class="btn btn-sm rounded-pill px-3 py-1" :class="workoutForm.activity===a.name ? 'btn-secondary' : 'btn-outline-secondary'" @click="workoutForm.activity=a.name">
                            {{ a.icon }} {{ a.name }}
                        </button>
                    </div>
                </div>
        ...
        <div ref="toastRef" class="toast position-fixed bottom-0 start-50 translate-middle-x m-3" role="alert" aria-live="assertive" aria-atomic="true" data-bs-delay="3000" data-bs-autohide="true">
