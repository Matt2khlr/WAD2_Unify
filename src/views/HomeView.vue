              ...
              <div class="card-body d-flex flex-column">
                <div class="d-flex justify-content-between align-items-center mb-3 pb-2 border-bottom">
                  ...
                  <div class="ios-switch-container">
                    <input type="checkbox" v-model="syncEnabled" id="weekGoogleSync" class="ios-switch-input"
                      @change="toggleSync">
                ...
                <div class="flex-grow-1 overflow-auto" style="max-height: 400px;">
                        ...
                        <div v-for="event in dayGroup.events" :key="event.id"
                          ...
                          <div class="d-flex align-items-start justify-content-between gap-2">
                            ...
                            <button v-if="event.location || event.locationName" @click.stop="openMap(event)"
                              class="map-button" title="Open in Google Maps">
                  ...
                  <div v-else class="text-center py-5">
                    <i class="mdi mdi-calendar-blank-outline " style="font-size: 3rem; opacity: 0.3;"></i>
                ...
                <div v-if="modules.length > 0" class="d-flex flex-column gap-3">
                  <div v-for="m in modules" :key="m.name">
                    ...
                    <div class="progress" style="height: 8px;">
                      <div class="progress-bar" role="progressbar" :style="{ width: m.progress + '%' }"
                        :aria-valuenow="m.progress" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                  </div>
                </div>
          ...
          <div class="col-12 col-lg-6">
            <div class="card h-100">
              <div class="card-body d-flex flex-column">
                ...
                <div v-else-if="journalHistory.length" class="d-flex flex-column gap-2 flex-grow-1">
                  <div v-for="entry in journalHistory.slice(0, 3)" :key="entry.id"
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-2">
                      ...
                      <span v-if="entry.mood" class="badge rounded-pill" :class="getMoodColorClass(entry.mood)"
                ...
                <div v-else class="text-center py-4 flex-grow-1 d-flex flex-column justify-content-center">
